...
@section('content')
    <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
        <div>
            <h3 class="fw-bold mb-3">Data Pendaftar Pembayaran Diterima</h3>
            ...
            <div class="card card-round">
                <div class="card-header">
                    <div class="card-head-row card-tools-still-right">
                        <div class="card-title">Data Pembayaran Diterima</div>
                ...
                <div class="card-body">
                    ...
                    <div class="row mb-4">
                        <div class="col-md-5">
                            <form method="GET" action="{{ route('pendaftar.pembayaran.diterima') }}" id="filterForm">
                        ...
                        <div class="col-md-5">
                            <form method="GET" action="{{ route('pendaftar.pembayaran.diterima') }}" id="searchForm">
                                ...
                                <div class="input-group">
                                    ...
                                    @if(request('search') || request('periode_id'))
                                        <a href="{{ route('pendaftar.pembayaran.diterima') }}" class="btn btn-secondary">
