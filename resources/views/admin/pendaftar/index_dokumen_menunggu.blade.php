        ...
        <div class="col-md-12">
            <div class="card card-round">
                ...
                <div class="card-body">
                    ...
                    <div class="row mb-4">
                        <div class="col-md-5">
                            <form method="GET" action="{{ route('pendaftar.dokumen.menunggu') }}" id="filterForm">
                        ...
                        <div class="col-md-5">
                            <form method="GET" action="{{ route('pendaftar.dokumen.menunggu') }}" id="searchForm">
                                ...
                                <div class="input-group">
                                    ...
                                    @if(request('search') || request('periode_id'))
                                        <a href="{{ route('pendaftar.dokumen.menunggu') }}" class="btn btn-secondary">
