...
@section('content')
    <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
        <div>
            <h3 class="fw-bold mb-3">Data Pendaftar Diterima</h3>
        ...
        <div class="col-md-12">
            <div class="card card-round">
                ...
                <div class="card-body">
                    ...
                    <div class="row mb-4">
                        <div class="col-md-6">
                            <form method="GET" action="{{ route('pendaftar.diterima') }}" class="d-flex align-items-end">
                                ...
                                @if(request('periode_id'))
                                    <div>
                                        <a href="{{ route('pendaftar.diterima') }}" class="btn btn-secondary">
